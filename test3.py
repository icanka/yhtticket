...
async def select_feature(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    context.user_data[START_OVER] = False
    logging.info("method: select_feature youre now in state SELECTING_FEATURE: %s", SELECTING_FEATURE)
...
async def ask_for_input(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    logging.info("method: ask_for_input youre now in state TYPING: %s", TYPING)
    return TYPING
...
async def save_input(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    logging.info("method: save_input")
...
async def end_describing(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    logging.info("method: end_describing youre now in state END: %s", END)
    logging.info("callback_query_data: %s", update.callback_query.data)
    return END
...
async def stop_nested(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    logging.info("method: stop_nested youre now in state STOPPING: %s", STOPPING)
    return STOPPING
